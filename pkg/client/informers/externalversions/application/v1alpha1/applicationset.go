...
import (
	...
	apisapplicationv1alpha1 "github.com/hanzoai/cd/pkg/apis/application/v1alpha1"
	versioned "github.com/hanzoai/cd/pkg/client/clientset/versioned"
	internalinterfaces "github.com/hanzoai/cd/pkg/client/informers/externalversions/internalinterfaces"
	applicationv1alpha1 "github.com/hanzoai/cd/pkg/client/listers/application/v1alpha1"
...
func NewApplicationSetInformerWithOptions(client versioned.Interface, namespace string, options internalinterfaces.InformerOptions) cache.SharedIndexInformer {
	gvr := schema.GroupVersionResource{Group: "apps.hanzo.ai", Version: "v1alpha1", Resource: "applicationsets"}
	...
	return cache.NewSharedIndexInformerWithOptions(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(opts v1.ListOptions) (runtime.Object, error) {
				...
				return client.AppsV1alpha1().ApplicationSets(namespace).List(context.Background(), opts)
			},
			WatchFunc: func(opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.AppsV1alpha1().ApplicationSets(namespace).Watch(context.Background(), opts)
			},
			ListWithContextFunc: func(ctx context.Context, opts v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.AppsV1alpha1().ApplicationSets(namespace).List(ctx, opts)
			},
			WatchFuncWithContext: func(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&opts)
				}
				return client.AppsV1alpha1().ApplicationSets(namespace).Watch(ctx, opts)
			},
		}, client),
