...
// AppV1alpha1Client is used to interact with features provided by the apps.hanzo.ai group.
type AppV1alpha1Client struct {
	restClient rest.Interface
}

func (c *AppV1alpha1Client) AppProjects(namespace string) AppProjectInterface {
	return newAppProjects(c, namespace)
}

func (c *AppV1alpha1Client) Applications(namespace string) ApplicationInterface {
	return newApplications(c, namespace)
}

func (c *AppV1alpha1Client) ApplicationSets(namespace string) ApplicationSetInterface {
