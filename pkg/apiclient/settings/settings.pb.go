...
// Settings Service
//
// Settings Service API retrieves Hanzo CD settings
...
import (
	...
	oidc "github.com/hanzoai/cd/server/settings/oidc"
...
// SettingsQuery is a query for Hanzo CD settings
...
var fileDescriptor_a480d494da040caa = []byte{
	...
	,
}
