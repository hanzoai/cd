...
var (
	pattern_GPGKeyService_List_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "gpgkeys"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_GPGKeyService_Get_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1", "gpgkeys", "keyID"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_GPGKeyService_Create_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "gpgkeys"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_GPGKeyService_Delete_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "gpgkeys"}, "", runtime.AssumeColonVerbOpt(true)))
)
