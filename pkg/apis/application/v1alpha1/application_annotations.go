...
const (
	...
	AnnotationKeyRefresh string = "cd.hanzo.ai/refresh"
	...
	AnnotationKeyHydrate string = "cd.hanzo.ai/hydrate"
	...
	AnnotationKeyManifestGeneratePaths = "cd.hanzo.ai/manifest-generate-paths"
	// AnnotationKeyManagedByURL contains the URL of the Hanzo CD instance managing the application
	AnnotationKeyManagedByURL = "cd.hanzo.ai/managed-by-url"
)
