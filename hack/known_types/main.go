...
func newCommand() *cobra.Command {
	...
	command := &cobra.Command{
		Use:     "go run github.com/hanzoai/cd/hack/known_types ALIAS PACKAGE_PATH OUTPUT_PATH",
		Example: "go run github.com/hanzoai/cd/hack/known_types corev1 k8s.io/api/core/v1 corev1_known_types.go",
	...
	knownTypes["%s/%s"] = func() any {
		return &%s.%s{}
			...
			res := fmt.Sprintf(`// Code generated by github.com/hanzoai/cd/hack/known_types. DO NOT EDIT.
package normalizers
