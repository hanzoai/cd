...
func ConstructApplicationSet(fileURL string) ([]*appv1.ApplicationSet, error) {
	if fileURL != "" {
...
func constructAppsetFromFileURL(fileURL string) ([]*appv1.ApplicationSet, error) {
	appset := make([]*appv1.ApplicationSet, 0)
	// read uri
...
func readAppsetFromURI(fileURL string, appset *[]*appv1.ApplicationSet) error {
...
func readAppset(yml []byte, appsets *[]*appv1.ApplicationSet) error {
