...
type cdAdditionalNamespaces struct {
...
// NewAdminCommand returns a new instance of an cd command
func NewAdminCommand(clientOpts *cdclient.ClientOptions) *cobra.Command {
...
// Get additional namespaces from cd-cmd-params
func getAdditionalNamespaces(ctx context.Context, configMapsClient dynamic.ResourceInterface) *cdAdditionalNamespaces {
