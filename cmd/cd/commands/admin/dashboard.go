...
type dashboard struct {
	startLocalServer func(ctx context.Context, clientOpts *cdclient.ClientOptions, contextName string, port *int, address *string, clientConfig clientcmd.ClientConfig) (func(), error)
}
...
func NewDashboardCommand(clientOpts *cdclient.ClientOptions) *cobra.Command {
...
$ cd admin dashboard --port 8080 --address 127.0.0.1

# Start the Hanzo CD Web UI with GZip compression
$ cd admin dashboard --redis-compress gzip
  `,
	}
