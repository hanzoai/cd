...
// Test_exportResources tests for the resources exported when using the `cd admin export` command
...
`,
		...
		{
			name:         "Application should be in the exported manifest when created in the default 'cd' namespace",
			object:       newApplication("cd"),
			namespace:    "cd",
			expectExport: true,
			expectedFileContent: `apiVersion: ""
kind: Application
...
`,
		...
		{
			name:                "Application should not be in the exported manifest when it's neither created in the default namespace nor in enabled namespace",
		...
		{
			name:         "ApplicationSet should be in the exported manifest when created in the default 'cd' namespace",
			object:       newApplicationSet("cd"),
			namespace:    "cd",
			expectExport: true,
			expectedFileContent: `apiVersion: ""
kind: ApplicationSet
...
`,
		...
		{
			name:                "ApplicationSet should not be in the exported manifest when neither created in the default 'cd' namespace nor in enabled namespaces",
