...
func TestLogout(t *testing.T) {
	...
	command := NewLogoutCommand(&cdclient.ClientOptions{ConfigPath: testConfigFilePath})
	...
	assert.Contains(t, localConfig.Contexts, localconfig.ContextRef{Name: "cd1.example.com:443", Server: "cd1.example.com:443", User: "cd1.example.com:443"})
...
func TestLogout_TLSCheckFails_AutoSetsPlainText(t *testing.T) {
	...
	command := NewLogoutCommand(&cdclient.ClientOptions{ConfigPath: configFile})
