...
func NewProjectCreateCommand(clientOpts *cdclient.ClientOptions) *cobra.Command {
	...
	command := &cobra.Command{
		...
		Example: templates.Examples(`
			...
			cd proj create PROJECT -f FILE|URL
		`),
		Run: func(c *cobra.Command, args []string) {
			ctx := c.Context()
...
func NewProjectSetCommand(clientOpts *cdclient.ClientOptions) *cobra.Command {
	...
	command := &cobra.Command{
		...
		Example: templates.Examples(`
			...
			cd proj set PROJECT --allow-cluster-resource [RES1,RES2,...]

			# Set project parameters with some denied namespaced resources [RES1,RES2,...] for project with name PROJECT
			cd proj set PROJECT ---deny-namespaced-resource [RES1,RES2,...]
		`),
		Run: func(c *cobra.Command, args []string) {
			ctx := c.Context()
...
func NewProjectAddSignatureKeyCommand(clientOpts *cdclient.ClientOptions) *cobra.Command {
	command := &cobra.Command{
		...
		Example: templates.Examples(`
			...
			cd proj add-signature-key PROJECT KEY-ID
		`),
...
func NewProjectRemoveSignatureKeyCommand(clientOpts *cdclient.ClientOptions) *cobra.Command {
	command := &cobra.Command{
		...
		Example: templates.Examples(`
			...
			cd proj remove-signature-key PROJECT KEY-ID
		`),
		Deprecated: "Managing project signature keys through CLI is deprecated, migrate to Source Integrity defined in AppProject manifest",
		Run: func(c *cobra.Command, args []string) {
			ctx := c.Context()
...
func NewProjectRemoveDestinationCommand(clientOpts *cdclient.ClientOptions) *cobra.Command {
	command := &cobra.Command{
		...
		Example: templates.Examples(`
			...
			cd proj remove-destination PROJECT SERVER NAMESPACE
		`),
		Run: func(c *cobra.Command, args []string) {
			ctx := c.Context()
...
func NewProjectAddOrphanedIgnoreCommand(clientOpts *cdclient.ClientOptions) *cobra.Command {
	...
	command := &cobra.Command{
		...
		cd proj add-orphaned-ignore PROJECT GROUP KIND
		...
		cd proj add-orphaned-ignore PROJECT GROUP KIND --name NAME
		`),
		Run: func(c *cobra.Command, args []string) {
			ctx := c.Context()
...
func NewProjectRemoveOrphanedIgnoreCommand(clientOpts *cdclient.ClientOptions) *cobra.Command {
	...
	command := &cobra.Command{
		...
		cd proj remove-orphaned-ignore PROJECT GROUP KIND
		...
		cd proj remove-orphaned-ignore PROJECT GROUP KIND --name NAME
		`),
		Run: func(c *cobra.Command, args []string) {
			ctx := c.Context()
...
func NewProjectAddSourceCommand(clientOpts *cdclient.ClientOptions) *cobra.Command {
	command := &cobra.Command{
		...
		Example: templates.Examples(`
			...
			cd proj add-source PROJECT URL
		`),
		Run: func(c *cobra.Command, args []string) {
			ctx := c.Context()
...
func NewProjectAddSourceNamespace(clientOpts *cdclient.ClientOptions) *cobra.Command {
	command := &cobra.Command{
		...
		Example: templates.Examples(`
			...
			cd proj add-source-namespace PROJECT NAMESPACE
		`),
		Run: func(c *cobra.Command, args []string) {
			ctx := c.Context()
...
func NewProjectRemoveSourceNamespace(clientOpts *cdclient.ClientOptions) *cobra.Command {
	command := &cobra.Command{
		...
		Example: templates.Examples(`
			...
			cd proj remove-source-namespace PROJECT NAMESPACE
		`),
		Run: func(c *cobra.Command, args []string) {
			ctx := c.Context()
...
func NewProjectAllowNamespaceResourceCommand(clientOpts *cdclient.ClientOptions) *cobra.Command {
	...
	cd proj allow-namespace-resource PROJECT GROUP KIND
	`
...
func NewProjectDenyNamespaceResourceCommand(clientOpts *cdclient.ClientOptions) *cobra.Command {
	...
	cd proj deny-namespace-resource PROJECT GROUP KIND
	`
	getProjIf := func(cmd *cobra.Command) (io.Closer, projectpkg.ProjectServiceClient) {
		return headless.NewClientOrDie(clientOpts, cmd).NewProjectClientOrDie()
	}
...
func NewProjectAllowClusterResourceCommand(clientOpts *cdclient.ClientOptions) *cobra.Command {
	...
	cd proj allow-cluster-resource PROJECT GROUP KIND NAME
	`
	getProjIf := func(cmd *cobra.Command) (io.Closer, projectpkg.ProjectServiceClient) {
		return headless.NewClientOrDie(clientOpts, cmd).NewProjectClientOrDie()
	}
...
func NewProjectRemoveSourceCommand(clientOpts *cdclient.ClientOptions) *cobra.Command {
	command := &cobra.Command{
		...
		Example: templates.Examples(`
			...
			cd proj remove-source PROJECT URL
		`),
		Run: func(c *cobra.Command, args []string) {
			ctx := c.Context()
...
func getProject(ctx context.Context, c *cobra.Command, clientOpts *cdclient.ClientOptions, projName string) *projectpkg.DetailedProjectsResponse {
	conn, projIf := headless.NewClientOrDie(clientOpts, c).NewProjectClientOrDie()
	defer utilio.Close(conn)
...
func NewProjectAddDestinationServiceAccountCommand(clientOpts *cdclient.ClientOptions) *cobra.Command {
	...
	command := &cobra.Command{
		...
		Example: templates.Examples(`
			...
			cd proj add-destination-service-account PROJECT SERVER NAMESPACE SERVICE_ACCOUNT

			# Add project destination service account (SERVICE_ACCOUNT) from a different namespace
			cd proj add-destination PROJECT SERVER NAMESPACE SERVICE_ACCOUNT --service-account-namespace <service_account_namespace>
		`),
		Run: func(c *cobra.Command, args []string) {
			ctx := c.Context()
...
func NewProjectRemoveDestinationServiceAccountCommand(clientOpts *cdclient.ClientOptions) *cobra.Command {
	command := &cobra.Command{
		...
		Example: templates.Examples(`
			...
			cd proj remove-destination-service-account PROJECT SERVER NAMESPACE SERVICE_ACCOUNT
		`),
		Run: func(c *cobra.Command, args []string) {
			ctx := c.Context()
