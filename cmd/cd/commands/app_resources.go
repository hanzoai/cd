...
func NewApplicationGetResourceCommand(clientOpts *cdclient.ClientOptions) *cobra.Command {
  ...
  # Get a specific resource, Pod my-app-pod, in 'my-app' by name in wide format
    cd app get-resource my-app --kind Pod --resource-name my-app-pod

  # Get a specific resource, Pod my-app-pod, in 'my-app' by name in yaml format
    cd app get-resource my-app --kind Pod --resource-name my-app-pod -o yaml

  # Get a specific resource, Pod my-app-pod, in 'my-app' by name in json format
    cd app get-resource my-app --kind Pod --resource-name my-app-pod -o json

  # Get details about all Pods in the application
    cd app get-resource my-app --kind Pod

  # Get a specific resource with managed fields, Pod my-app-pod, in 'my-app' by name in wide format
    cd app get-resource my-app --kind Pod --resource-name my-app-pod --show-managed-fields

  # Get the details of a specific field in a resource in 'my-app' in the wide format
    cd app get-resource my-app --kind Pod --filter-fields status.podIP

  # Get the details of multiple specific fields in a specific resource in 'my-app' in the wide format
    cd app get-resource my-app --kind Pod --resource-name my-app-pod --filter-fields status.podIP,status.hostIP`,
	}
