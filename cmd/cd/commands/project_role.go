...
$ cd proj role add-policy test-project test-role -a update -p allow -o project
...
$ cd proj role add-policy test-project test-role -a get -p allow -o project -r logs
...
func NewProjectRoleCreateCommand(clientOpts *cdclient.ClientOptions) *cobra.Command {
  ...
  cd proj role create my-project my-role --description "My project role description"
  		`),
...
func NewProjectRoleDeleteCommand(clientOpts *cdclient.ClientOptions) *cobra.Command {
	command := &cobra.Command{
		...
		Example: `$ cd proj role delete test-project test-role`,
		Run: func(c *cobra.Command, args []string) {
			ctx := c.Context()
...
func NewProjectRoleCreateTokenCommand(clientOpts *cdclient.ClientOptions) *cobra.Command {
	...
	command := &cobra.Command{
		...
		Example: `$ cd proj role create-token test-project test-role
...
func NewProjectRoleListTokensCommand(clientOpts *cdclient.ClientOptions) *cobra.Command {
	...
	command := &cobra.Command{
		...
		Example: `$ cd proj role list-tokens test-project test-role
ID                                      ISSUED AT                    EXPIRES AT
...
func NewProjectRoleListCommand(clientOpts *cdclient.ClientOptions) *cobra.Command {
	...
	command := &cobra.Command{
		...
		Example: templates.Examples(`
  # This command will list all the roles in cd-project in a default table format.
  cd proj role list PROJECT

  # List the roles in the project in formats like json, yaml, wide, or name.
  cd proj role list PROJECT --output json
...
func NewProjectRoleGetCommand(clientOpts *cdclient.ClientOptions) *cobra.Command {
	command := &cobra.Command{
		...
		Example: `$ cd proj role get test-project test-role
Role Name:     test-role
Description:
Policies:
p, proj:test-project:test-role, projects, get, test-project, allow
