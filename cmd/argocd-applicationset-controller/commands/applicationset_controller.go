...
func NewCommand() *cobra.Command {
	...
	command.Flags().StringVar(&argocdRepoServer, "argocd-repo-server", env.StringFromEnv("CD_APPLICATIONSET_CONTROLLER_REPO_SERVER", common.DefaultRepoServerAddr), "Hanzo CD repo server address")
