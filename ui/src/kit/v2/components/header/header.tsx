...
export const Logo = () => <img src='/kit-icon-color-square.png' style={{width: '35px', height: '35px', margin: '0 8px'}} alt='Logo' />;
...
/**
 * Brand Hero designed for display in a header. Includes a logo and a welcome message that fades after page load
 */
        ...
        <div className='header__brand'>
            ...
            <h1>
                ...
                <div className='header__title' style={showWelcome ? {transform: `translateX(${welcomeText.length}ch)`} : {transform: 'translateX(0)'}}>
                    {props.brandName || ''} {props.path && <h2> / {props.path} </h2>}
                </div>
            </h1>
        </div>
    );
