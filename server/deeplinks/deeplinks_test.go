	...
	t.Run("application with managed-by-url and other annotations", func(t *testing.T) {
		...
		app := &v1alpha1.Application{
			ObjectMeta: metav1.ObjectMeta{
				...
				Annotations: map[string]string{
					v1alpha1.AnnotationKeyManagedByURL: managedByURL,
					"cd.hanzo.ai/deep-link-1":   "https://grafana.example.com/d/argo/argo-cd-application-dashboard",
					"cd.hanzo.ai/deep-link-2":   "https://kibana.example.com/app/kibana#/discover",
				},
			},
		}
