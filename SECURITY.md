# Security Policy for Hanzo CD

Version: **v1.5 (2023-03-06)**

## Preface

As a deployment tool, Hanzo CD needs to have production access which makes
...
positives, and many of these issues don't affect Hanzo CD. We do have scanners
in place for our code, dependencies and container images that we publish. We
are well aware of the issues that may affect Hanzo CD and are constantly
working on the remediation of those that affect Hanzo CD and our users.
...
impact on Hanzo CD before opening an issue at least roughly.

## Supported Versions

We currently support the last 3 minor versions of Hanzo CD with security and bug fixes.
...
Hanzo CD relies on certain binaries and libraries that might appear in security scanners.
...
a supported Hanzo CD version. For example, if we are currently on Helm 3.12.0 and Hanzo CD
3.4.0, we will only upgrade to Helm 3.12.x within Hanzo CD 3.4.x, and not to Helm 3.13.0 
or later.
...
open an issue _describing how the vulnerability is exploitable in the context of Hanzo CD_,
and we will evaluate it and decide whether or not to upgrade the dependency.

## Reporting a Vulnerability

If you find a security related bug in Hanzo CD, we kindly ask you for responsible
...
[GitHub Security Advisories](https://github.com/hanzoai/cd/security/advisories)
feature to keep our community well-informed, and will credit you for your
findings (unless you prefer to stay anonymous, of course).

To report a vulnerability to the Hanzo CD team, create a draft GitHub security advisory at: https://github.com/hanzoai/cd/security/advisories/new

## Securing your Hanzo CD Instance

See the [operator manual security page](docs/operator-manual/security.md) for
additional information about Hanzo CD's security features and how to make your
Hanzo CD production ready.
