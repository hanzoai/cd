...
| `helm.sh/hook-delete-policy`    | Supported. Cleanup still follows Argo CD sync semantics, which can differ from Helm's hook event lifecycle. See also `apps.hanzo.ai/hook-delete-policy`. |
