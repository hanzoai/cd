# `cd admin settings resource-overrides health` Command Reference

## cd admin settings resource-overrides health

Assess resource health

### Synopsis

Assess resource health using the lua script configured in the 'resource.customizations' field of 'cd-cm' ConfigMap

```
cd admin settings resource-overrides health RESOURCE_YAML_PATH [flags]
```
