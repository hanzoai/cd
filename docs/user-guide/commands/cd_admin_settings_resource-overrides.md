# `cd admin settings resource-overrides` Command Reference

## cd admin settings resource-overrides

Troubleshoot resource overrides

```
cd admin settings resource-overrides [flags]
```
...
* [cd admin settings resource-overrides health](cd_admin_settings_resource-overrides_health.md)	 - Assess resource health
* [cd admin settings resource-overrides ignore-differences](cd_admin_settings_resource-overrides_ignore-differences.md)	 - Renders fields excluded from diffing
* [cd admin settings resource-overrides ignore-resource-updates](cd_admin_settings_resource-overrides_ignore-resource-updates.md)	 - Renders fields excluded from resource updates
* [cd admin settings resource-overrides list-actions](cd_admin_settings_resource-overrides_list-actions.md)	 - List available resource actions
* [cd admin settings resource-overrides run-action](cd_admin_settings_resource-overrides_run-action.md)	 - Executes resource action
