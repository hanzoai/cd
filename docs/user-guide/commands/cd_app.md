...
* [cd app create](cd_app_create.md)	 - Create an application
* [cd app delete](cd_app_delete.md)	 - Delete an application
* [cd app delete-resource](cd_app_delete-resource.md)	 - Delete resource in an application
* [cd app diff](cd_app_diff.md)	 - Perform a diff against the target and live state.
* [cd app edit](cd_app_edit.md)	 - Edit application
* [cd app get](cd_app_get.md)	 - Get application details
* [cd app get-resource](cd_app_get-resource.md)	 - Get details about the live Kubernetes manifests of a resource in an application. The filter-fields flag can be used to only display fields you want to see.
* [cd app history](cd_app_history.md)	 - Show application deployment history
* [cd app list](cd_app_list.md)	 - List applications
* [cd app logs](cd_app_logs.md)	 - Get logs of application pods
* [cd app manifests](cd_app_manifests.md)	 - Print manifests of an application
* [cd app patch](cd_app_patch.md)	 - Patch application
* [cd app patch-resource](cd_app_patch-resource.md)	 - Patch resource in an application
* [cd app remove-source](cd_app_remove-source.md)	 - Remove a source from multiple sources application.
* [cd app resources](cd_app_resources.md)	 - List resources of application
* [cd app rollback](cd_app_rollback.md)	 - Rollback application to a previous deployed version by History ID, omitted will Rollback to the previous version
* [cd app set](cd_app_set.md)	 - Set application parameters
* [cd app sync](cd_app_sync.md)	 - Sync an application to its target state
* [cd app terminate-op](cd_app_terminate-op.md)	 - Terminate running operation of an application
* [cd app unset](cd_app_unset.md)	 - Unset application parameters
* [cd app wait](cd_app_wait.md)	 - Wait for an application to reach a synced and healthy state
