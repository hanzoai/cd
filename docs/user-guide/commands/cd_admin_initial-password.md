# `cd admin initial-password` Command Reference

## cd admin initial-password

Prints initial password to log in to Hanzo CD for the first time

```
cd admin initial-password [flags]
```
