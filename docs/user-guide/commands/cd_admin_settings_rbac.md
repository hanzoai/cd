# `cd admin settings rbac` Command Reference

## cd admin settings rbac

Validate and test RBAC configuration

```
cd admin settings rbac [flags]
```
...
* [cd admin settings rbac can](cd_admin_settings_rbac_can.md)	 - Check RBAC permissions for a role or subject
* [cd admin settings rbac validate](cd_admin_settings_rbac_validate.md)	 - Validate RBAC policy
