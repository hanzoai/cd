# `cd admin cluster namespaces` Command Reference

## cd admin cluster namespaces

Print information namespaces which Hanzo CD manages in each cluster.

```
cd admin cluster namespaces [flags]
```
...
* [cd admin cluster namespaces disable-namespaced-mode](cd_admin_cluster_namespaces_disable-namespaced-mode.md)	 - Disable namespaced mode for clusters which name matches to the specified pattern.
* [cd admin cluster namespaces enable-namespaced-mode](cd_admin_cluster_namespaces_enable-namespaced-mode.md)	 - Enable namespaced mode for clusters which name matches to the specified pattern.
