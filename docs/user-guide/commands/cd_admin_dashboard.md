# `cd admin dashboard` Command Reference

## cd admin dashboard

Starts Hanzo CD Web UI locally

```
cd admin dashboard [flags]
```

### Examples

```
# Start the Hanzo CD Web UI locally on the default port and address
$ cd admin dashboard
