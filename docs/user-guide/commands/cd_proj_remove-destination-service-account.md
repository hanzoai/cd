# `cd proj remove-destination-service-account` Command Reference

## cd proj remove-destination-service-account

Remove default destination service account from the project

```
cd proj remove-destination-service-account PROJECT SERVER NAMESPACE SERVICE_ACCOUNT [flags]
```
