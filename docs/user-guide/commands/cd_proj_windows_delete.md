# `cd proj windows delete` Command Reference

## cd proj windows delete

Delete a sync window from a project. Requires ID which can be found by running "cd proj windows list PROJECT"

```
cd proj windows delete PROJECT ID [flags]
```
