# `cd proj windows update` Command Reference

## cd proj windows update

Update a project sync window

### Synopsis

Update a project sync window. Requires ID which can be found by running "cd proj windows list PROJECT"

```
cd proj windows update PROJECT ID [flags]
```
