# `cd proj source-integrity git policies list` Command Reference

## cd proj source-integrity git policies list
...
```
cd proj source-integrity git policies list PROJECT [flags]
```
