# `cd proj role list-tokens` Command Reference

## cd proj role list-tokens

List tokens for a given role.

```
cd proj role list-tokens PROJECT ROLE-NAME [flags]
```

### Examples

```
$ cd proj role list-tokens test-project test-role
