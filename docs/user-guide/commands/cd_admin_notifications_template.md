# `cd admin notifications template` Command Reference

## cd admin notifications template

Notification templates related commands

```
cd admin notifications template [flags]
```
...
* [cd admin notifications template get](cd_admin_notifications_template_get.md)	 - Prints information about configured templates
* [cd admin notifications template notify](cd_admin_notifications_template_notify.md)	 - Generates notification using the specified template and send it to specified recipients
