# `cd admin cluster namespaces enable-namespaced-mode` Command Reference

## cd admin cluster namespaces enable-namespaced-mode

Enable namespaced mode for clusters which name matches to the specified pattern.

```
cd admin cluster namespaces enable-namespaced-mode PATTERN [flags]
```
