# `cd admin settings validate` Command Reference

## cd admin settings validate

Validate settings

### Synopsis

Validates settings specified in 'cd-cm' ConfigMap and 'cd-secret' Secret

```
cd admin settings validate [flags]
```
