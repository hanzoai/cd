...
* [cd cluster rm](cd_cluster_rm.md)	 - Remove cluster credentials
* [cd cluster rotate-auth](cd_cluster_rotate-auth.md)	 - cd cluster rotate-auth SERVER/NAME
* [cd cluster set](cd_cluster_set.md)	 - Set cluster information
