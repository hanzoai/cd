# `cd admin settings resource-overrides ignore-differences` Command Reference

## cd admin settings resource-overrides ignore-differences

Renders fields excluded from diffing

### Synopsis

Renders ignored fields using the 'ignoreDifferences' setting specified in the 'resource.customizations' field of 'cd-cm' ConfigMap

```
cd admin settings resource-overrides ignore-differences RESOURCE_YAML_PATH [flags]
```
