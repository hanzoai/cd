# `cd admin proj generate-allow-list` Command Reference

## cd admin proj generate-allow-list

Generates project allow list from the specified clusterRole file

```
cd admin proj generate-allow-list CLUSTERROLE_PATH PROJ_NAME [flags]
```
...
```
# Generates project allow list from the specified clusterRole file
cd admin proj generate-allow-list /path/to/clusterrole.yaml my-project
```
