# `cd cluster rotate-auth` Command Reference

## cd cluster rotate-auth

cd cluster rotate-auth SERVER/NAME

```
cd cluster rotate-auth SERVER/NAME [flags]
```

### Examples

```
cd cluster rotate-auth https://12.34.567.89
