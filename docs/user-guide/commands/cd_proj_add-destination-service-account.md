# `cd proj add-destination-service-account` Command Reference

## cd proj add-destination-service-account

Add project destination's default service account

```
cd proj add-destination-service-account PROJECT SERVER NAMESPACE SERVICE_ACCOUNT [flags]
```
