# `cd admin settings resource-overrides ignore-resource-updates` Command Reference

## cd admin settings resource-overrides ignore-resource-updates

Renders fields excluded from resource updates

### Synopsis

Renders ignored fields using the 'ignoreResourceUpdates' setting specified in the 'resource.customizations' field of 'cd-cm' ConfigMap

```
cd admin settings resource-overrides ignore-resource-updates RESOURCE_YAML_PATH [flags]
```
