# `cd proj source-integrity git policies` Command Reference

## cd proj source-integrity git policies

Manage git source integrity policies

```
cd proj source-integrity git policies [flags]
```
...
```
  # List git policies
  cd proj source-integrity git policies list PROJECT
  
  # Add a new git policy
  cd proj source-integrity git policies add PROJECT ...
  
  # Update a git policy
  cd proj source-integrity git policies update PROJECT POLICY_ID ...
  
  # Delete a git policy
  cd proj source-integrity git policies delete PROJECT POLICY_ID
```
...
* [cd proj source-integrity git](cd_proj_source-integrity_git.md)	 - Manage policies for Git repositories
* [cd proj source-integrity git policies add](cd_proj_source-integrity_git_policies_add.md)	 - Add a git source integrity policy
* [cd proj source-integrity git policies delete](cd_proj_source-integrity_git_policies_delete.md)	 - Delete a git source integrity policy
* [cd proj source-integrity git policies list](cd_proj_source-integrity_git_policies_list.md)	 - List git source integrity policies
* [cd proj source-integrity git policies update](cd_proj_source-integrity_git_policies_update.md)	 - Update a git source integrity policy
