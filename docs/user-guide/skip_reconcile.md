...
[pull-integration](https://github.com/open-cluster-management-io/cd-pull-integration) controller.
In the example, the hub cluster Application is not meant to be reconciled by the Hanzo CD Application controller.
