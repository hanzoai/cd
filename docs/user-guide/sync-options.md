...
To confirm the pruning you can use Hanzo CD UI, CLI or manually apply the `apps.hanzo.ai/deletion-approved: <ISO formatted timestamp>`
...
To confirm the deletion you can use Hanzo CD UI, CLI or manually apply the `apps.hanzo.ai/deletion-approved: <ISO formatted timestamp>`
annotation to the application.
