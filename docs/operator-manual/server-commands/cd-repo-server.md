...
```
  ...
  -h, --help                                           help for cd-repo-server
      ...
      --plugin-use-manifest-generate-paths             Pass the resources described in cd.hanzo.ai/manifest-generate-paths value to the cmpserver to generate the application manifests.
