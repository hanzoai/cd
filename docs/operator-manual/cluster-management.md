...
```bash
kubectl -n argocd annotate secret <cluster-secret-name> apps.hanzo.ai/skip-reconcile=true
```
...
```bash
kubectl -n argocd annotate secret <cluster-secret-name> apps.hanzo.ai/skip-reconcile-
```
