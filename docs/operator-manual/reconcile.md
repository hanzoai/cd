...
For untracked resources, you can [use the apps.hanzo.ai/ignore-resource-updates annotations](#ignoring-updates-for-untracked-resources)
...
`apps.hanzo.ai/ignore-resource-updates=true` annotation in the dependent resources manifest.
...
spec:
  ...
  jobTemplate:
    metadata:
      annotations:
        apps.hanzo.ai/ignore-resource-updates: 'true'
    spec:
      template:
        metadata:
          annotations:
