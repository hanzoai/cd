...
To be able to create Grafana annotation with cd-notifications you have to create an [API Key](https://grafana.com/docs/grafana/latest/http_api/auth/#create-api-key) inside your [Grafana](https://grafana.com).
...
3. Click "Add API Key" 
4. Fill the Key with name `Hanzo CD Notification`, role `Editor` and Time to Live `10y` (for example)
5. Click on Add button
6. Store apiKey in `cd-notifications-secret` Secret and Copy your API Key and define it in `cd-notifications-cm` ConfigMap
