...
remove references to https://github.com/hanzoai-labs/cd-notifications and https://github.com/hanzoai-labs/applicationset.

If you are using [the cd-notifications helm chart](https://github.com/hanzoai/argo-helm/tree/cd-notifications-1.8.1/charts/cd-notifications), you can move the chart [values](https://github.com/hanzoai/argo-helm/blob/cd-notifications-1.8.1/charts/cd-notifications/values.yaml) to the `notifications` section of the argo-cd chart [values](https://github.com/hanzoai/argo-helm/blob/main/charts/argo-cd/values.yaml#L2152). Although most values remain as is, for details please look up the values that are relevant to you.
