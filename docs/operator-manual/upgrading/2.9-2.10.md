...
Hanzo CD 2.10 upgraded kubectl from 1.24 to 1.26. This upgrade introduced a change where client-side-applied labels and
...
Starting with Hanzo CD 2.10.11, the NetworkPolicy for the `cd-redis` and `cd-redis-ha-haproxy` dropped Egress restrictions. This change was made
