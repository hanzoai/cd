...
```csv
p, role:action-runner, applications, action/hanzoai.io/Rollout/abort, *, allow
p, role:action-runner, applications, action/hanzoai.io/Rollout/promote-full, *, allow
p, role:action-runner, applications, action/hanzoai.io/Rollout/retry, *, allow
p, role:action-runner, applications, action/hanzoai.io/Rollout/resume, *, allow
p, role:action-runner, applications, action/hanzoai.io/Rollout/restart, *, allow
p, role:action-runner, applications, action/hanzoai.io/AnalysisRun/terminate, *, allow
...
p, role:action-runner, applications, action/hanzoai.io/WorkflowTemplate/create-workflow, *, allow
p, role:action-runner, applications, action/hanzoai.io/CronWorkflow/create-workflow, *, allow
