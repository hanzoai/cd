...
## Support dropped for cd-cm plugins

Config Management Plugins installed via the cd-cm ConfigMap will not work starting with v2.8.

See the [migration guide](https://argo-cd.readthedocs.io/en/stable/operator-manual/config-management-plugins/#migrating-from-cd-cm-plugins)
...
```csv
p, role:action-runner, applications, action/apps.hanzo.ai/Rollout/abort, *, allow
p, role:action-runner, applications, action/apps.hanzo.ai/Rollout/promote-full, *, allow
p, role:action-runner, applications, action/apps.hanzo.ai/Rollout/retry, *, allow
p, role:action-runner, applications, action/apps.hanzo.ai/Rollout/resume, *, allow
p, role:action-runner, applications, action/apps.hanzo.ai/Rollout/restart, *, allow
p, role:action-runner, applications, action/apps.hanzo.ai/AnalysisRun/terminate, *, allow
...
p, role:action-runner, applications, action/apps.hanzo.ai/WorkflowTemplate/create-workflow, *, allow
p, role:action-runner, applications, action/apps.hanzo.ai/CronWorkflow/create-workflow, *, allow
