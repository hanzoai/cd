...
> Users operating large monorepos may encounter repo-server lock contention requiring pod restarts. A [fix](https://github.com/hanzoai/cd/pull/25127) is under review and will be included in the next patch release.
...
## Hanzo CD Now Respects Kustomize Version in `.cd-source.yaml`

Hanzo CD provides a way to [override Application `spec.source` values](../../user-guide/parameters.md#store-overrides-in-git)
using the `.cd-source.yaml` file.

Before Hanzo CD v3.2, you could set the Kustomize version in the Application's `.spec.source.kustomize.version` field,
but you could not set it in the `.cd-source.yaml` file.

Starting with Hanzo CD v3.2, you can now set the Kustomize version in the `.cd-source.yaml` file like this:
...
> health check using the `resource.customizations.health.batch_CronJob` key in the cd-cm ConfigMap.
> 
...
`cd.hanzo.ai/ignore-healthcheck: "true"` on the CronJob resource.
...
field in the `cd-cmd-params-cm` ConfigMap.

## Added Healthchecks

* [datadoghq.com/DatadogMetric](https://github.com/hanzoai/cd/commit/5c9a5ef9a65f8e04e729fbae54a9310c0a42f6c2)
* [CronJob](https://github.com/hanzoai/cd/commit/d3de4435ce86f3f85a4cc58978b2544af2ac4248)
* [promoter.apps.hanzo.ai/Hanzo CDCommitStatus](https://github.com/hanzoai/cd/commit/36f1a59c09ad4ef384689fa0699ff7eba60f4a20)
* [promoter.apps.hanzo.ai/ChangeTransferPolicy](https://github.com/hanzoai/cd/commit/36f1a59c09ad4ef384689fa0699ff7eba60f4a20)
* [promoter.apps.hanzo.ai/CommitStatus](https://github.com/hanzoai/cd/commit/36f1a59c09ad4ef384689fa0699ff7eba60f4a20)
* [promoter.apps.hanzo.ai/PromotionStrategy](https://github.com/hanzoai/cd/commit/36f1a59c09ad4ef384689fa0699ff7eba60f4a20)
* [promoter.apps.hanzo.ai/PullRequest](https://github.com/hanzoai/cd/commit/36f1a59c09ad4ef384689fa0699ff7eba60f4a20)
* [coralogix.com/Alert](https://github.com/hanzoai/cd/commit/dcf1965c529790855647f036e4e7ea0323fbf812)
* [coralogix.com/RecordingRuleGroupSet](https://github.com/hanzoai/cd/commit/dcf1965c529790855647f036e4e7ea0323fbf812)
* [projectcontour.io/ExtensionService](https://github.com/hanzoai/cd/commit/4e63bc756394d93c684b6b8e8b3856e0e6b3f199)
* [clickhouse-keeper.altinity.com/ClickHouseKeeperInstallation](https://github.com/hanzoai/cd/commit/c447628913da1c0134bbb1d21a9ae366804b4a8e)
* [clickhouse.altinity.com/ClickHouseInstallation](https://github.com/hanzoai/cd/commit/c447628913da1c0134bbb1d21a9ae366804b4a8e)
* [apps.3scale.net/APIManager](https://github.com/hanzoai/cd/commit/d954789d47276354371556ff97e6a7c3840440e0)
* [capabilities.3scale.net/ActiveDoc](https://github.com/hanzoai/cd/commit/d954789d47276354371556ff97e6a7c3840440e0)
* [capabilities.3scale.net/ApplicationAuth](https://github.com/hanzoai/cd/commit/d954789d47276354371556ff97e6a7c3840440e0)
* [capabilities.3scale.net/Application](https://github.com/hanzoai/cd/commit/d954789d47276354371556ff97e6a7c3840440e0)
* [capabilities.3scale.net/Backend](https://github.com/hanzoai/cd/commit/d954789d47276354371556ff97e6a7c3840440e0)
* [capabilities.3scale.net/CustomPolicyDefinition](https://github.com/hanzoai/cd/commit/d954789d47276354371556ff97e6a7c3840440e0)
* [capabilities.3scale.net/DeveloperAccount](https://github.com/hanzoai/cd/commit/d954789d47276354371556ff97e6a7c3840440e0)
* [capabilities.3scale.net/DeveloperUser](https://github.com/hanzoai/cd/commit/d954789d47276354371556ff97e6a7c3840440e0)
* [capabilities.3scale.net/OpenAPI](https://github.com/hanzoai/cd/commit/d954789d47276354371556ff97e6a7c3840440e0)
* [capabilities.3scale.net/Product](https://github.com/hanzoai/cd/commit/d954789d47276354371556ff97e6a7c3840440e0)
* [capabilities.3scale.net/ProxyConfigPromote](https://github.com/hanzoai/cd/commit/d954789d47276354371556ff97e6a7c3840440e0)
* [capabilities.3scale.net/Tenant](https://github.com/hanzoai/cd/commit/d954789d47276354371556ff97e6a7c3840440e0)