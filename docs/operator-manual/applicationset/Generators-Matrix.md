...
Next, the Cluster generator scans the [set of clusters defined in Hanzo CD](Generators-Cluster.md), finds the staging and production cluster secrets, and produce two corresponding sets of parameters:
```yaml
- name: staging
