...
Sure thing! You can either open an Enhancement Proposal in our GitHub issue tracker or you can [join us on Slack](https://hanzoai.github.io/community/join-slack) in channel #argo-contributors to discuss your ideas and get guidance for submitting a PR.
...
Conventionally an initial review is performed by an Argo member or reviewer. Once the initial review is approved, it can be labeled `ready-for-review` and then added to the [Hanzo CD Review](https://github.com/orgs/hanzoai/projects/28) Github project. The project dashboard provides a helpful [info panel](https://github.com/orgs/hanzoai/projects/28?pane=info) on the review process.
