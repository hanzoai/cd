The Hanzo CD UI displays icons for various Kubernetes resource types to help users quickly identify them. Hanzo CD 
...
2. Add the icon file to the `ui/src/assets/images/resources/<group>/icon.svg` path in the Hanzo CD repository.
...
5. Create a pull request to the Hanzo CD repository with your changes.
