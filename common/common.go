...
const (
	...
	LabelKeyAutoLabelClusterInfo = "cd.hanzo.ai/auto-label-cluster-info"
	...
	AnnotationKeyAppInstance = "cd.hanzo.ai/tracking-id"
	AnnotationInstallationID = "cd.hanzo.ai/installation-id"

	// AnnotationCompareOptions is a comma-separated list of options for comparison
	AnnotationCompareOptions = "cd.hanzo.ai/compare-options"

	// AnnotationClientSideApplyMigrationManager specifies a custom field manager for client-side apply migration
	AnnotationClientSideApplyMigrationManager = "cd.hanzo.ai/client-side-apply-migration-manager"

	// AnnotationIgnoreHealthCheck when set on an Application's immediate child indicates that its health check
	// can be disregarded.
	AnnotationIgnoreHealthCheck = "cd.hanzo.ai/ignore-healthcheck"
	...
	AnnotationValueManagedByArgoCD = "cd.hanzo.ai"
	...
	// The annotation key must be followed by a unique identifier. Ex: link.cd.hanzo.ai/dashboard
	...
	AnnotationKeyLinkPrefix = "link.cd.hanzo.ai/"
	...
	AnnotationKeyIgnoreDefaultLinks = "cd.hanzo.ai/ignore-default-links"
	...
	AnnotationKeyAppSkipReconcile = "cd.hanzo.ai/skip-reconcile"
...
const (
	...
	AnnotationApplicationSetRefresh = "cd.hanzo.ai/application-set-refresh"
)
