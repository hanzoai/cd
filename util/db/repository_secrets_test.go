...
func TestSecretsRepositoryBackend_GetRepository(t *testing.T) {
	...
	assert.Equal(t, "git@github.com:hanzoai/hanzoai.git", repository.Repo)
	...
	repository, err = testee.GetRepository(t.Context(), "git@github.com:hanzoai/hanzoai.git", "testProject")
	require.NoError(t, err)
	assert.NotNil(t, repository)
...
func TestSecretsRepositoryBackend_UpdateRepository(t *testing.T) {
	...
	userProvidedRepository := &appsv1.Repository{
		Name:     "User Provided",
		Repo:     "git@github.com:hanzoai/hanzoai.git",
	...
	newRepository := &appsv1.Repository{
		Name:     "New",
		Repo:     "git@github.com:hanzoai/argo-events.git",
		Username: "foo",
		Password: "bar",
	}
