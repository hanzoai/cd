...
func TestAddCacheFlagsToCmd_SentinelEnvDefaults(t *testing.T) {
	t.Setenv("KV_SENTINEL_HOSTS", "redis1:26379,redis2:26379")
	t.Setenv("KV_SENTINEL_MASTER", "mymaster")
...
func TestAddCacheFlagsToCmd_SentinelFlagOverridesEnv(t *testing.T) {
	t.Setenv("KV_SENTINEL_MASTER", "env-master")
	t.Setenv("KV_SENTINEL_HOSTS", "env1:26379")
