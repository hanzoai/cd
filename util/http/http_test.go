...
func TestCookieMaxLength(t *testing.T) {
	...
	require.EqualError(t, err, "the authentication token is 81760 characters long and requires 21 cookies but the max number of cookies is 20. Contact your Hanzo CD administrator to increase the max number of cookies")
