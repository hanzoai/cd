...
func TestIsHookOfType(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			annot:    map[string]string{"apps.hanzo.ai/hook": "PreDelete"},
			expected: true,
		},
		{
		...
		},
		{
			...
			annot:    map[string]string{"apps.hanzo.ai/hook": "PostDelete"},
			expected: true,
		},
		{
...
func TestIsHook(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			annot:    map[string]string{"apps.hanzo.ai/hook": "PreSync"},
			expected: true,
		},
		{
			name:     "Not a hook",
...
func TestIsPreDeleteHook(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			annot:    map[string]string{"apps.hanzo.ai/hook": "PostDelete,PreDelete"},
			expected: true,
		},
	}
...
func TestPartitionTargetObjsForSync(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			in: []*unstructured.Unstructured{
				newObj("combined", map[string]string{"apps.hanzo.ai/hook": "PostSync,PreDelete,PostDelete"}),
			},
		...
		},
		{
			...
			in: []*unstructured.Unstructured{
				newObj("pre-del", map[string]string{"apps.hanzo.ai/hook": "PreDelete"}),
			},
			wantNames:      nil,
			wantPreDelete:  true,
		...
		},
		{
			...
			in: []*unstructured.Unstructured{
				newObj("post-del", map[string]string{"apps.hanzo.ai/hook": "PostDelete"}),
			},
			wantNames:      nil,
			wantPreDelete:  false,
			wantPostDelete: true,
...
func TestMultiHookOfType(t *testing.T) {
	tests := []struct {
...

		{
			...
			hookType: []HookType{PreDeleteHookType, PostDeleteHookType},
			annot:    map[string]string{"apps.hanzo.ai/hook": "PreDelete,PostDelete"},
			expected: true,
		},
	}
...
func TestExecuteHooksAlreadyExistsLogic(t *testing.T) {
	...
	tests := []struct {
		...
		//  PRE DELETE TESTS
		{
			...
			targetAnnot:   map[string]string{"apps.hanzo.ai/hook": "PreDelete"},
			liveAnnot:     nil,
			expectCreated: true,
		},
		{
		...
		},
		{
			...
			hookType:      []HookType{PreDeleteHookType},
			targetAnnot:   map[string]string{"apps.hanzo.ai/hook": "PreDelete"},
			liveAnnot:     map[string]string{"apps.hanzo.ai/hook": "PreDelete"},
			expectCreated: false,
		},
		{
			name:          "PreDelete (argocd): Already exists - should be skipped",
		...
		},
		{
			...
			hookType:      []HookType{PreDeleteHookType},
			targetAnnot:   map[string]string{"helm.sh/hook": "pre-delete", "apps.hanzo.ai/hook": "PreDelete"},
			liveAnnot:     map[string]string{"helm.sh/hook": "pre-delete"},
			expectCreated: false,
		},
		{
		...
		//  POST DELETE TESTS
		{
			...
			targetAnnot:   map[string]string{"apps.hanzo.ai/hook": "PostDelete"},
			liveAnnot:     nil,
			expectCreated: true,
		},
		{
		...
		},
		{
			...
			hookType:      []HookType{PostDeleteHookType},
			targetAnnot:   map[string]string{"apps.hanzo.ai/hook": "PostDelete"},
			liveAnnot:     map[string]string{"apps.hanzo.ai/hook": "PostDelete"},
			expectCreated: false,
		},
		{
		...
		},
		{
			...
			hookType:      []HookType{PostDeleteHookType},
			targetAnnot:   map[string]string{"helm.sh/hook": "post-delete", "apps.hanzo.ai/hook": "PostDelete"},
			liveAnnot:     map[string]string{"helm.sh/hook": "post-delete", "apps.hanzo.ai/hook": "PostDelete"},
			expectCreated: false,
		},
		{
		...
		//  MULTI HOOK TESTS - SKIP LOGIC
		{
			...
			hookType:      []HookType{PreDeleteHookType, PostDeleteHookType},
			targetAnnot:   map[string]string{"apps.hanzo.ai/hook": "PreDelete,PostDelete"},
			liveAnnot:     map[string]string{"apps.hanzo.ai/hook": "PreDelete,PostDelete"},
			expectCreated: false,
		},
		{
