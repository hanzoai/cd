...
func TestShouldHashManifest(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:        "cd.hanzo.ai/ignore-resource-updates=true",
			appName:     "",
			gvk:         schema.GroupVersionKind{Group: application.Group, Kind: "kind1"},
			un:          &unstructured.Unstructured{},
			annotations: map[string]string{"cd.hanzo.ai/ignore-resource-updates": "true"},
			want:        true,
		},
		{
			name:        "cd.hanzo.ai/ignore-resource-updates=invalid",
			appName:     "",
			gvk:         schema.GroupVersionKind{Group: application.Group, Kind: "kind1"},
			un:          &unstructured.Unstructured{},
			annotations: map[string]string{"cd.hanzo.ai/ignore-resource-updates": "invalid"},
			want:        false,
		},
		{
			name:        "cd.hanzo.ai/ignore-resource-updates=false",
			appName:     "",
			gvk:         schema.GroupVersionKind{Group: application.Group, Kind: "kind1"},
			un:          &unstructured.Unstructured{},
			annotations: map[string]string{"cd.hanzo.ai/ignore-resource-updates": "false"},
			want:        false,
		},
	}
