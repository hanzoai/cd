...
hs.status = "Unknown"
hs.message = "Elasticsearch Cluster status is unknown. Ensure your Hanzo CD is current and then check for/file a bug report: https://github.com/hanzocd/cd/issues"
return hs
