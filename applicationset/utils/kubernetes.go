...
func GetSecretRef(ctx context.Context, k8sClient client.Client, ref *appv1alpha1.SecretRef, namespace string, tokenRefStrictMode bool) (string, error) {
	if ref == nil {
		return "", nil
	}
...
func GetConfigMapData(ctx context.Context, k8sClient client.Client, ref *appv1alpha1.ConfigMapKeyRef, namespace string) ([]byte, error) {
	if ref == nil {
		return nil, nil
	}
