...
func nestedGeneratorsHaveClusterGenerator(generators []v1alpha1.ApplicationSetNestedGenerator) (bool, error) {
...
func nestedGeneratorHasClusterGenerator(nested v1alpha1.ApplicationSetNestedGenerator) (bool, error) {
	if nested.Clusters != nil {
		return true, nil
	}

	if nested.Matrix != nil {
		nestedMatrix, err := v1alpha1.ToNestedMatrixGenerator(nested.Matrix)
		if err != nil {
	...
	if nested.Merge != nil {
		nestedMerge, err := v1alpha1.ToNestedMergeGenerator(nested.Merge)
		if err != nil {
