...
func (g *SCMProviderGenerator) GetRequeueAfter(appSetGenerator *appv1alpha1.ApplicationSetGenerator) time.Duration {
...
func (g *SCMProviderGenerator) GetTemplate(appSetGenerator *appv1alpha1.ApplicationSetGenerator) *appv1alpha1.ApplicationSetTemplate {
...
func ScmProviderAllowed(applicationSetInfo *appv1alpha1.ApplicationSet, generator SCMGeneratorWithCustomApiUrl, allowedScmProviders []string) error {
...
func (g *SCMProviderGenerator) GenerateParams(appSetGenerator *appv1alpha1.ApplicationSetGenerator, applicationSetInfo *appv1alpha1.ApplicationSet, _ client.Client) ([]map[string]any, error) {
...
func (g *SCMProviderGenerator) githubProvider(ctx context.Context, github *appv1alpha1.SCMProviderGeneratorGithub, applicationSetInfo *appv1alpha1.ApplicationSet, baseHTTPClient *http.Client) (scm_provider.SCMProviderService, error) {
