...
func (g *GitGenerator) generateParamsForGitDirectories(appSetGenerator *v1alpha1.ApplicationSetGenerator, noRevisionCache bool, sourceIntegrity *v1alpha1.SourceIntegrity, useGoTemplate bool, project string, goTemplateOptions []string) ([]map[string]any, error) {
...
func (g *GitGenerator) generateParamsForGitFiles(appSetGenerator *v1alpha1.ApplicationSetGenerator, noRevisionCache bool, sourceIntegrity *v1alpha1.SourceIntegrity, useGoTemplate bool, project string, goTemplateOptions []string) ([]map[string]any, error) {
...
func (g *GitGenerator) filterApps(directories []v1alpha1.GitDirectoryGeneratorItem, allPaths []string) []string {
	var res []string
...
func (g *GitGenerator) generateParamsFromApps(requestedApps []string, appSetGenerator *v1alpha1.ApplicationSetGenerator, useGoTemplate bool, goTemplateOptions []string) ([]map[string]any, error) {
