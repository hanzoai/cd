...
func Transform(requestedGenerator appv1alpha1.ApplicationSetGenerator, allGenerators map[string]Generator, baseTemplate appv1alpha1.ApplicationSetTemplate, appSet *appv1alpha1.ApplicationSet, genParams map[string]any, client client.Client) ([]TransformResult, error) {
...
func GetRelevantGenerators(requestedGenerator *appv1alpha1.ApplicationSetGenerator, generators map[string]Generator) []Generator {
	var res []Generator
...
func mergeGeneratorTemplate(g Generator, requestedGenerator *appv1alpha1.ApplicationSetGenerator, applicationSetTemplate appv1alpha1.ApplicationSetTemplate) (appv1alpha1.ApplicationSetTemplate, error) {
...
func InterpolateGenerator(requestedGenerator *appv1alpha1.ApplicationSetGenerator, params map[string]any, useGoTemplate bool, goTemplateOptions []string) (appv1alpha1.ApplicationSetGenerator, error) {
	render := utils.Render{}
	...
	if err != nil {
		...
		return appv1alpha1.ApplicationSetGenerator{}, err
	}
