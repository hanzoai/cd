...
type PullRequestGenerator struct {
	...
	selectServiceProviderFunc func(context.Context, *appv1alpha1.PullRequestGenerator, *appv1alpha1.ApplicationSet) (pullrequest.PullRequestService, error)
	SCMConfig
}
...
func (g *PullRequestGenerator) GetRequeueAfter(appSetGenerator *appv1alpha1.ApplicationSetGenerator) time.Duration {
...
func (g *PullRequestGenerator) GetContinueOnRepoNotFoundError(appSetGenerator *appv1alpha1.ApplicationSetGenerator) bool {
	return appSetGenerator.PullRequest.ContinueOnRepoNotFoundError
}

func (g *PullRequestGenerator) GetTemplate(appSetGenerator *appv1alpha1.ApplicationSetGenerator) *appv1alpha1.ApplicationSetTemplate {
	return &appSetGenerator.PullRequest.Template
}

func (g *PullRequestGenerator) GenerateParams(appSetGenerator *appv1alpha1.ApplicationSetGenerator, applicationSetInfo *appv1alpha1.ApplicationSet, _ client.Client) ([]map[string]any, error) {
...
func (g *PullRequestGenerator) selectServiceProvider(ctx context.Context, generatorConfig *appv1alpha1.PullRequestGenerator, applicationSetInfo *appv1alpha1.ApplicationSet) (pullrequest.PullRequestService, error) {
	...
	if generatorConfig.GitLab != nil {
		...
		return pullrequest.NewGitLabService(token, providerConfig.API, providerConfig.Project, providerConfig.Labels, providerConfig.PullRequestState, g.scmRootCAPath, providerConfig.Insecure, caCerts, g.scmProxyURL, g.scmNoProxy)
	}
	...
	if generatorConfig.BitbucketServer != nil {
		...
		if providerConfig.BearerToken != nil {
			...
			return pullrequest.NewBitbucketServiceBearerToken(ctx, appToken, providerConfig.API, providerConfig.Project, providerConfig.Repo, g.scmRootCAPath, providerConfig.Insecure, caCerts, g.scmProxyURL, g.scmNoProxy)
			...
			return pullrequest.NewBitbucketServiceBasicAuth(ctx, providerConfig.BasicAuth.Username, password, providerConfig.API, providerConfig.Project, providerConfig.Repo, g.scmRootCAPath, providerConfig.Insecure, caCerts, g.scmProxyURL, g.scmNoProxy)
		}
		return pullrequest.NewBitbucketServiceNoAuth(ctx, providerConfig.API, providerConfig.Project, providerConfig.Repo, g.scmRootCAPath, providerConfig.Insecure, caCerts, g.scmProxyURL, g.scmNoProxy)
	}
...
func (g *PullRequestGenerator) github(ctx context.Context, cfg *appv1alpha1.PullRequestGeneratorGithub, applicationSetInfo *appv1alpha1.ApplicationSet) (pullrequest.PullRequestService, error) {
