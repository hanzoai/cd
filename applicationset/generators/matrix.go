...
func (m *MatrixGenerator) GenerateParams(appSetGenerator *appv1alpha1.ApplicationSetGenerator, appSet *appv1alpha1.ApplicationSet, client client.Client) ([]map[string]any, error) {
...
func (m *MatrixGenerator) getParams(appSetBaseGenerator appv1alpha1.ApplicationSetNestedGenerator, appSet *appv1alpha1.ApplicationSet, params map[string]any, client client.Client) ([]map[string]any, error) {
...
func (m *MatrixGenerator) GetRequeueAfter(appSetGenerator *appv1alpha1.ApplicationSetGenerator) time.Duration {
	res := maxDuration
	var found bool
...
func getMatrixGenerator(r appv1alpha1.ApplicationSetNestedGenerator) (*appv1alpha1.MatrixGenerator, error) {
	if r.Matrix == nil {
		return nil, nil
	}
	matrix, err := appv1alpha1.ToNestedMatrixGenerator(r.Matrix)
	if err != nil {
		return nil, err
	}
...
func (m *MatrixGenerator) GetTemplate(appSetGenerator *appv1alpha1.ApplicationSetGenerator) *appv1alpha1.ApplicationSetTemplate {
