...
func (g *PluginGenerator) getPluginFromGenerator(ctx context.Context, appSetName string, generatorConfig *v1alpha1.PluginGenerator) (*plugin.Service, error) {
...
func (g *PluginGenerator) generateParams(appSetGenerator *v1alpha1.ApplicationSetGenerator, appSet *v1alpha1.ApplicationSet, objectsFound []map[string]any, pluginParams v1alpha1.PluginParameters, useGoTemplate bool) ([]map[string]any, error) {
	res := []map[string]any{}
	...
	for _, objectFound := range objectsFound {
		...
		params["generator"] = map[string]any{
			"input": map[string]v1alpha1.PluginParameters{
