...
func (m *MergeGenerator) getParamSetsForAllGenerators(generators []appv1alpha1.ApplicationSetNestedGenerator, appSet *appv1alpha1.ApplicationSet, client client.Client) ([][]map[string]any, error) {
...
func (m *MergeGenerator) GenerateParams(appSetGenerator *appv1alpha1.ApplicationSetGenerator, appSet *appv1alpha1.ApplicationSet, client client.Client) ([]map[string]any, error) {
...
func (m *MergeGenerator) getParams(appSetBaseGenerator appv1alpha1.ApplicationSetNestedGenerator, appSet *appv1alpha1.ApplicationSet, client client.Client) ([]map[string]any, error) {
	...
	t, err := Transform(
		appv1alpha1.ApplicationSetGenerator{
		...
		appv1alpha1.ApplicationSetTemplate{},
		appSet,
...
func (m *MergeGenerator) GetRequeueAfter(appSetGenerator *appv1alpha1.ApplicationSetGenerator) time.Duration {
	res := maxDuration
	var found bool
	...
	for _, r := range appSetGenerator.Merge.Generators {
		...
		base := &appv1alpha1.ApplicationSetGenerator{
			List:                    r.List,
			Clusters:                r.Clusters,
			Git:                     r.Git,
...
func getMergeGenerator(r appv1alpha1.ApplicationSetNestedGenerator) (*appv1alpha1.MergeGenerator, error) {
	if r.Merge == nil {
		return nil, nil
	}
	merge, err := appv1alpha1.ToNestedMergeGenerator(r.Merge)
	if err != nil {
...
func (m *MergeGenerator) GetTemplate(appSetGenerator *appv1alpha1.ApplicationSetGenerator) *appv1alpha1.ApplicationSetTemplate {
