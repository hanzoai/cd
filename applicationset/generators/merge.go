...
func (m *MergeGenerator) getParamSetsForAllGenerators(generators []v1alpha1.ApplicationSetNestedGenerator, appSet *v1alpha1.ApplicationSet, client client.Client) ([][]map[string]any, error) {
...
func (m *MergeGenerator) getParams(appSetBaseGenerator v1alpha1.ApplicationSetNestedGenerator, appSet *v1alpha1.ApplicationSet, client client.Client) ([]map[string]any, error) {
...
func getMergeGenerator(r v1alpha1.ApplicationSetNestedGenerator) (*v1alpha1.MergeGenerator, error) {
	if r.Merge == nil {
		return nil, nil
	}
	merge, err := v1alpha1.ToNestedMergeGenerator(r.Merge)
	if err != nil {
