...
func compileFilters(filters []v1alpha1.PullRequestGeneratorFilter) ([]*Filter, error) {
...
func ListPullRequests(ctx context.Context, provider PullRequestService, filters []v1alpha1.PullRequestGeneratorFilter) ([]*PullRequest, error) {
