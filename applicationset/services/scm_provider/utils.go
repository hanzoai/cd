...
func compileFilters(filters []appv1alpha1.SCMProviderGeneratorFilter) ([]*Filter, error) {
...
func ListRepos(ctx context.Context, provider SCMProviderService, filters []appv1alpha1.SCMProviderGeneratorFilter, cloneProtocol string) ([]*Repository, error) {
