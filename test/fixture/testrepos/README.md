...
Starts the Docker container with the test Git server. Mounts the current directory and `CD_E2E_DIR` (default: `/tmp/cd-e2e`), exposing ports for SSH and HTTP/HTTPS access.
