...
func TestManagedByURLWithAnnotation(t *testing.T) {
	...
	ctx.
		...
		And(func() {
			...
			for i := range 3 {
				appObj, err := fixture.AppClientset.AppV1alpha1().Applications(fixture.ArgoCDNamespace).Get(t.Context(), ctx.GetName(), metav1.GetOptions{})
				...
				_, err = fixture.AppClientset.AppV1alpha1().Applications(fixture.ArgoCDNamespace).Update(t.Context(), appObj, metav1.UpdateOptions{})
				if err == nil {
					break
				}
				if i == 2 {
