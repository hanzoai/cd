...
import (
	...
	. "github.com/hanzoai/cd/test/e2e/fixture/admin"
	. "github.com/hanzoai/cd/test/e2e/fixture/admin/utils"
	appfixture "github.com/hanzoai/cd/test/e2e/fixture/app"
)
...
func TestBackupExportImport(t *testing.T) {
	...
	ctx.
		...
		AndCLIOutput(func(_ string, err error) {
			...
			_, err = fixture.AppClientset.AppsV1alpha1().Applications(appTestNamespace.GetNamespace()).Get(t.Context(), appTestNamespace.GetName(), metav1.GetOptions{})
			require.NoError(t, err, "failed getting test namespace application after import")
			_, err = fixture.AppClientset.AppsV1alpha1().Applications(appOtherNamespace.GetNamespace()).Get(t.Context(), appOtherNamespace.GetName(), metav1.GetOptions{})
