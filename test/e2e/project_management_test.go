...
func TestProjectCreation(t *testing.T) {
	...
	proj, err := fixture.AppClientset.AppV1alpha1().AppProjects(fixture.TestNamespace()).Get(t.Context(), projectName, metav1.GetOptions{})
	require.NoError(t, err)
...
func TestProjectDeletion(t *testing.T) {
	...
	proj, err := fixture.AppClientset.AppV1alpha1().AppProjects(fixture.TestNamespace()).Create(
	...
	_, err = fixture.AppClientset.AppV1alpha1().AppProjects(fixture.TestNamespace()).Get(t.Context(), projectName, metav1.GetOptions{})
...
func TestSetProject(t *testing.T) {
	...
	projectName := "proj-" + strconv.FormatInt(time.Now().Unix(), 10)
	_, err := fixture.AppClientset.AppV1alpha1().AppProjects(fixture.TestNamespace()).Create(
		t.Context(), &v1alpha1.AppProject{ObjectMeta: metav1.ObjectMeta{Name: projectName}}, metav1.CreateOptions{})
	require.NoError(t, err)
...
func TestRemoveProjectDestination(t *testing.T) {
	...
	projectName := "proj-" + strconv.FormatInt(time.Now().Unix(), 10)
	_, err := fixture.AppClientset.AppV1alpha1().AppProjects(fixture.TestNamespace()).Create(t.Context(), &v1alpha1.AppProject{
...
func TestUseJWTToken(t *testing.T) {
	...
	_, err = fixture.AppClientset.AppV1alpha1().Applications(fixture.TestNamespace()).Create(t.Context(), testApp, metav1.CreateOptions{})
	require.NoError(t, err)
	...
	newProj, err := fixture.AppClientset.AppV1alpha1().AppProjects(fixture.TestNamespace()).Get(t.Context(), projectName, metav1.GetOptions{})
	require.NoError(t, err)
...
func createAndConfigGlobalProject(ctx context.Context, testName string) error {
	...
	projGlobal, err := fixture.AppClientset.AppV1alpha1().AppProjects(fixture.TestNamespace()).Get(ctx, projectGlobalName, metav1.GetOptions{})
	if err != nil {
		return err
	}
	...
	_, err = fixture.AppClientset.AppV1alpha1().AppProjects(fixture.TestNamespace()).Update(ctx, projGlobal, metav1.UpdateOptions{})
	if err != nil {
		return err
	}
...
func TestGetVirtualProjectMatch(t *testing.T) {
	...
	proj, err := fixture.AppClientset.AppV1alpha1().AppProjects(fixture.TestNamespace()).Get(ctx, projectName, metav1.GetOptions{})
	require.NoError(t, err)

	// Add a label to this project so that this project match global project selector
	proj.Labels = map[string]string{"opt": "me"}
	_, err = fixture.AppClientset.AppV1alpha1().AppProjects(fixture.TestNamespace()).Update(ctx, proj, metav1.UpdateOptions{})
	require.NoError(t, err)
