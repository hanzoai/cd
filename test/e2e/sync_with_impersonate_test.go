...
func TestSyncWithValidSAButDisallowedDestination(t *testing.T) {
	...
	appCtx.
		...
		And(func() {
			...
			_, err := fixture.AppClientset.AppV1alpha1().AppProjects(fixture.TestNamespace()).Patch(t.Context(), projectCtx.GetName(), types.MergePatchType, patch, metav1.PatchOptions{})
